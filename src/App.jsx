...
class App extends Component {
  ...
  rederView = () => {
    this.setState({ displayText: this.state.userText });
  };

  render() {
    const { userText, sfont, color, isBold, isItalic, isUnderline, alignment } =
      this.state;
    const boldLogo = isBold ? "#faff00" : "#f1f5f9";
    const italicLogo = isItalic ? "#faff00" : "#f1f5f9";
    const underlineLogo = isUnderline ? "#faff00" : "#f1f5f9";
    const leftalign =
      alignment === alignmentConstants.leftalign ? "#faff00" : "#f1f5f9";
    const center =
      alignment === alignmentConstants.center ? "#faff00" : "#f1f5f9";
    const rightalign =
      alignment === alignmentConstants.rightalign ? "#faff00" : "#f1f5f9";
      ...
      <div className="bg-container">
        ...
        <TextEditorController>
          ...
          <div className="input-container">
            <InputContainer value={userText} onChange={this.onChangeText} />
            <AddButton onClick={this.rederView}>Add Text</AddButton>
          </div>
        </TextEditorController>
      </div>
    );
